...
class BaseModelArguments:
    ...
    sft_router: str = field(
        default="unfrozen",
        metadata={"help": "Frozen router during sft training or not."},
    )
    use_esft: bool = field(
        default=False,
        metadata={"help": "Whether use esft or not."},
    )
    esft_config_path: str = field(
        default="",
        metadata={"help": "esft config path"},
    )
    probmoe: bool = field(
        default=False,
