...
export WANDB_API_KEY="$WANDB_API_KEY" # set your wandb api key here
...
for config_file in "${CONFIG_FILES[@]}"; do
    ...
    # define the command
    CMD="CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 llamafactory-cli train examples/train_full/qwen1.5moe/${method}/${config_file}"
