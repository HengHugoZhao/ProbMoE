#!/bin/bash
# full.sh
# inhereted from DenseMixer @https://github.com/yaof20/DenseMixer/tree/main
# Usage example:
#   bash full.sh --task codealpaca --model_name_or_path allenai/OLMo-2-1124-7B --num_train_epochs 5 --task_extra_args "--other_option value"
#
# Description:
...
DEEPSPEED_CONFIG_FILE=${DEEPSPEED_CONFIG_FILE:-"ds_configs/stage3_no_offloading_accelerate.conf"}
...
CONFIG_FILE="finetune/script/configs/${TASK}.conf"
